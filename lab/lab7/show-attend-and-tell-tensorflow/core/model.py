...
class CaptionGenerator(object):
    def __init__(self, sh, word_to_idx, dim_feature=[196, 512], dim_embed=512, dim_hidden=1024, n_time_step=16, 
    ...
    def _attention_layer(self, features, features_proj, h, reuse=False):
        with tf.variable_scope('attention_layer', reuse=reuse):
            ...
            if self.sh == 's':
                ...
                alpha = tf.one_hot(tf.argmax(out_att, axis=1), depth=self.L)
